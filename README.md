Privacy Policy
This application is a private project in active development and is intended for testing, evaluation, and authorized use only.

We may collect and process limited data necessary to provide authentication, cloud save, and related functionality. This may include account identifiers, save data, gameplay progress, device information, and technical logs.

We use this information solely to operate, test, debug, and improve the application during development and any future release. We do not sell personal data.

Data may be stored or processed using third-party service providers that support authentication, cloud save, hosting, or related services.

By using this application, you acknowledge that it is under active development and may change, malfunction, or lose data.

Notice
This application, including its code, assets, design, systems, and related materials, is private and proprietary intellectual property. It is not licensed for public use, distribution, modification, reverse engineering, or commercial exploitation without the developer’s prior written permission.

LICENSE

Copyright (c) 2026 Joseph A Gobert and Michael A Gobert

All rights reserved.

This software, including all source code, documentation, designs, assets, and related materials, is the exclusive intellectual property of Joseph A Gobert and Michael A Gobert.

No person or entity may use, copy, modify, distribute, publish, sublicense, sell, reverse engineer, or otherwise exploit this software or any part of it without the prior written permission of Joseph A Gobert and Michael A Gobert
